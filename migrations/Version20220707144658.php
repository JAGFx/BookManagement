 ...
 */
final class Version20220707144658 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT AUTO_INCREMENT NOT NULL, categorie_id INT NOT NULL, user_id_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, borrowed TINYINT(1) NOT NULL, INDEX IDX_CBE5A331BCF5E72D (categorie_id), INDEX IDX_CBE5A3319D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE book ADD CONSTRAINT FK_CBE5A331BCF5E72D FOREIGN KEY (categorie_id) REFERENCES category (id)');
